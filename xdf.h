...
struct Stream
{
    ...
    //!
    std::variant<std::vector<std::vector<std::string>>,
    std::vector<std::vector<float>>,
    std::vector<std::vector<double>>,
    std::vector<std::vector<int>>,
    std::vector<std::vector<int64_t>>> time_series;
...
public:
    ...
    std::unordered_map<uint32_t, Stream> streams; /*!< Maps stream IDs to stream data of an XDF file. */
